...
<div class="container-fluid shadow">
    <div class="row justify-content-between">
        ...
        <div class="col-md">
            <h3 class="text-center mt-0">MESSAGE(S)</h3>
            <hr class="p-3">
            <div class="row justify-content-between">
                <?php
                ...
                $query1 = "SELECT * FROM messages WHERE receiver_no = '{$phone}' ORDER BY msg_id DESC";
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <a href="patient_message.php?delete=<?php echo $msg_id?>"
                        ...
                        <div class="modal" id="reply<?php echo $msg_id?>" tabindex="-1" role="dialog" aria-labelledby="replyLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <form action="patient_message.php?f_id=<?php echo $_SESSION['user_id']?>" method="post" enctype="multipart/form-data" class="lm-bold p-3">
