...
if (isset($_POST['register'])){
    ...
    if ($user_number==$phone_no){
        ...
        $query= "INSERT INTO users(phone_no,firstname,surname,gender,date_of_birth,next_of_kin,blood_group,genotype,user_role,picture,address,registered_date)";
        $query.=" VALUES('{$phone_no}', '{$firstname}','{$surname}', '{$gender}', '{$date_of_birth}', '{$next_of_kin}', '{$blood_group}', '{$genotype}', '{$user_role}', '{$picture}', '{$address}', '{$registered_date}')";
